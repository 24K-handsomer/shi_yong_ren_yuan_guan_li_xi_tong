...
<body>
	...
	<div id="row">
	<form name='MyForm' id='MyForm' method='GET' action="/index.php/Admin/Person/index" style ="padding-bottom:10px;">
        <span>搜&nbsp;&nbsp;&nbsp;索&nbsp;&nbsp;人&nbsp;&nbsp;名：</span>
        <input type="text" name="uname" placeholder="输入人名">
        <input type="submit" name="" value="搜索">
    </form>
    
	<form name='MyForm' id='MyForm' method='GET' action="/index.php/Admin/Person/selectgroup" >
        <span>搜索部门小组：</span>
        <select name="group">
	...
	<table border="1" cellpadding="0" cellspacing="0">
		...
		<?php if(is_array($list)): foreach($list as $key=>$v3): ?><tr>
			...
			<td>
				<?php if($v3["proknowledge"] == 0): ?><input class="chang" type="submit" name="proknowledge" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>"  test="<?php echo ($v3["proknowledge"]); ?>" value="启用">
				<?php else: ?>
					<input class="chang" type="submit" name="proknowledge" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>"  test="<?php echo ($v3["proknowledge"]); ?>" value="添加"><?php endif; ?>
			</td>
			<td>
				<?php if($v3["test2"] == 0): ?><input class="add" type="submit" name="test2" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>" test="<?php echo ($v3["test2"]); ?>" value="开通">
				<?php else: ?>
					<input class="add" type="submit" name="test2" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>" test="<?php echo ($v3["test2"]); ?>" value="添加"><?php endif; ?>
			</td>
			<td>
				<?php if($v3["sellskills"] == 0): ?><input class="chang" type="submit" name="sellskills" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>"  test="<?php echo ($v3["sellskills"]); ?>" value="启用">
				<?php else: ?>
					<input class="chang" type="submit" name="sellskills" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>"  test="<?php echo ($v3["sellskills"]); ?>" value="添加"><?php endif; ?>
			</td>
			<td>
				<?php if($v3["test3"] == 0): ?><input class="add" type="submit" name="test3" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>" test="<?php echo ($v3["test3"]); ?>" value="开通">
				<?php else: ?>
					<input class="add" type="submit" name="test3" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>" test="<?php echo ($v3["test3"]); ?>" value="添加"><?php endif; ?>
			</td>
			<td>
				<?php if($v3["speechcase"] == 0): ?><input class="chang" type="submit" name="speechcase" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>"  test="<?php echo ($v3["speechcase"]); ?>" value="启用">
				<?php else: ?>
					<input class="chang" type="submit" name="speechcase" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>"  test="<?php echo ($v3["speechcase"]); ?>" value="添加"><?php endif; ?>
			</td>
			<td>
				<?php if($v3["practice"] == 0): ?><input type="submit" name="practice" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>" test="<?php echo ($v3["practice"]); ?>" value="开通">
				<?php else: ?>
					<input type="submit" name="practice" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>" test="<?php echo ($v3["practice"]); ?>" value="关闭"><?php endif; ?>
			</td>
			<td>
				<?php if($v3["friend"] == 0): ?><input class="chang" type="submit" name="friend" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>"  test="<?php echo ($v3["friend"]); ?>" value="启用">
				<?php else: ?>
					<input class="chang" type="submit" name="friend" xu="<?php echo $j; ?>" ps="<?php echo ($v3["uid"]); ?>"  test="<?php echo ($v3["friend"]); ?>" value="添加"><?php endif; ?>
			</td>
		...
		<tr>
			...
			<td></td>
			<td>
				<input type="submit" name="add2" value="添加试题">
			</td>
			<td></td>
			<td>
				<input type="submit" name="add3" value="添加试题">
			</td>
			<td></td>
			<td>
				<input type="submit" name="on4" value="开通" >
				<input type="submit" name="off4" value="关闭">
			</td>
			<td></td>
			<td></td>
			<td></td>
