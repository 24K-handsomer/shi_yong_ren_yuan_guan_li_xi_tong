...
<body>
	...
	<span><?php echo ($task["uname"]); ?>任务操作</span>

                
            </div>
            
            
	<div id="row">给<?php echo ($task["uname"]); ?>添加任务</div>
	<form action="/index.php/Admin/Person/addtask" method="post">
		<input type="hidden" name="uid" value="<?php echo ($task["uid"]); ?>">
		<?php if($task['task7']==0): ?><input type="hidden" name="start" value="1"><?php endif; ?>
		<div id="row">
			<span>&nbsp;&nbsp;7天任务：</span>
			<input type="text" name="7task" value="<?php echo ($task["task7"]); ?>">
		</div>
		<div id="row">
			<span>14天任务：</span>
			<input type="text" name="14task" value="<?php echo ($task["task14"]); ?>">
		</div>
		<div id="row">
			<span>21天任务：</span>
			<input type="text" name="21task" value="<?php echo ($task["task21"]); ?>">
		</div>
		<div id="row">
			<span>30天任务：</span>
			<input type="text" name="30task" value="<?php echo ($task["task30"]); ?>">
		</div>
		<div id="table-top">
	...
	<div id="iframe">
		<?php if($task['task7'] != 0): ?><iframe src="/index.php/Kefu/Growth/taskshow?uid=<?php echo ($task["uid"]); ?>"></iframe><?php endif; ?>
	</div>
