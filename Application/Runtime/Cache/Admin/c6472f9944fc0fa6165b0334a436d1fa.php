...
<body>
	...
	<div id="row">
	<form name='MyForm' id='MyForm' method='GET' action="/index.php/Admin/Paper/index" >
        <span>试卷类型：</span>
        <select name="fileid">
	...
	<table border="1" cellpadding="0" cellspacing="0">
		...
		<?php if(is_array($list)): foreach($list as $key=>$v3): ?><tr id="">
			...
			<td>
				<a href="/index.php/Admin/Paper/showpaper?id=<?php echo ($v3["pid"]); ?>">查看</a>&nbsp;&nbsp;|&nbsp;&nbsp;
				<a href="">编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;
				<?php if($v3["status"] == 1): ?><input type="submit" class="status" name="status" xu="<?php echo ++$j ?>" ps="<?php echo ($v3["pid"]); ?>" status="<?php echo ($v3["status"]); ?>" value="禁用">
				<?php else: ?>
				<input type="submit" class="status" name="status" xu="<?php echo ++$j ?>" ps="<?php echo ($v3["pid"]); ?>" status="<?php echo ($v3["status"]); ?>" value="启用"><?php endif; ?>
			</td>
...
<script type="text/javascript">
 $(function(){
 	$("input[name='status']").click(function(){
 		...
 		$.ajax({
 			url:"/index.php/Admin/Paper/status",
