...
<body>
	...
	<table border="1" cellpadding="0" cellspacing="0">
		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr id="">
				...
				<td><?php echo ($v["biaoji"]); ?></td>
				<td><?php echo ($v["crtime"]); ?></td>
				<td>
					<input type="submit" name="delete" ps="<?php echo ($v["oid"]); ?>" value="删除">
				</td>
	...
	<div id="addorder">
		<form action="/index.php/Kefu/Growth/addorder" method="post">
		<span>添加订单：</span>
		<span>金额：</span>
	...
	<div id="iframe">
		<iframe src="/index.php/Kefu/Growth/taskshow?uid=<?php echo session('uid'); ?>"></iframe>
	</div>
...
$(function(){
	$("input[name='delete']").click(function(){
		var ps = $(this).attr("ps");
		$.ajax({
			url:"/index.php/Kefu/Growth/deleteorder",
			data:{oid:ps},
			type:"POST",
			dataType:"JSON",
